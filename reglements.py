...
Le jeu consiste à former des mots entrecroisés sur une grille avec des lettres de valeurs différentes, les cases de couleur de la grille permettant de multiplier la valeur des lettres ou des mots. Le gagnant est celui qui cumule le plus grand nombre de points à l'issue de la partie. Le jeu comporte 102 jetons (100 lettres et 2 jokers).

"""

    DEBUT = """
    
Chaque joueur pioche à tour de rôle une lettre dans le sac. Celui qui obtient la lettre la plus proche de A (dans l’ordre alphabétique) joue en premier. Si plusieurs joueurs ont pioché la même lettre, ils posent leur lettre sur la table puis piochent chacun une nouvelle lettre dans le sac.

Si un joueur a pioché un joker (lettre blanche), il le pose sur la table puis pioche une nouvelle lettre dans le sac. Une fois le premier joueur déterminé, l’ordre des joueurs suit l'ordre normal croissant.
...
Au coup suivant, seule la valeur de la lettre posée sur la case est prise en compte. Si un joueur utilise ses 7 pions pour former un mot, il a un bonus de 50 points. Chaque jeu de Scrabble possède 2 pions « blancs », ce sont les jokers.
